      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="px-6 space-y-5">
          ...
          >
            ...
            >
              <p>
                2025년 월드비전 합창단 기획연주 &lt; Sound of Mission&gt; 은
                1960년, 전쟁의 상처 속에서 희망의 노래로 시작되었던 월드비전
                합창단의 여정을 돌아보고, 그 아름다운 발자취를 함께 기억하는
                시간으로 기획되었습니다. 특별히 이번 무대에는 동문합창단이
                함께하여, 여러 세대가 한마음으로 노래하고 조화를 이루며,
                월드비전 합창단의 사명과 정신을 다시금 되새기는 뜻깊은 자리가 될
                것입니다.
              </p>
            </div>
          </motion.div>
